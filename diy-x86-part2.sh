...
sed -i 's/PKG_VERSION:=0.51.3/PKG_VERSION:=0.61.0/' feeds/packages/net/frp/Makefile
sed -i 's/PKG_HASH:=83032399773901348c660d41c967530e794ab58172ccd070db89d5e50d915fef/PKG_HASH:=c06a11982ef548372038ec99a6b01cf4f7817a9b88ee5064e41e5132d0ccb7e1/' feeds/packages/net/frp/Makefile
