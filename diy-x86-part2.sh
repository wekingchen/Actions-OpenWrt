...
# 修改frp版本为官网最新v0.63.0 https://github.com/fatedier/frp 格式：https://codeload.github.com/fatedier/frp/tar.gz/v${PKG_VERSION}?
sed -i 's/PKG_VERSION:=0.53.2/PKG_VERSION:=0.63.0/' feeds/packages/net/frp/Makefile
