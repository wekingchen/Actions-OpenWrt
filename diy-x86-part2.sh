...
# 修改tailscale版本为官网最新v1.66.2 https://github.com/tailscale/tailscale 格式：https://codeload.github.com/tailscale/tailscale/tar.gz/v$(PKG_VERSION)?
sed -i 's/PKG_VERSION:=1.66.1/PKG_VERSION:=1.66.2/' feeds/packages/net/tailscale/Makefile
sed -i 's/PKG_HASH:=a3c8645891d2dd25ad417df16e7f635cdf98d2c01778614942c6e39218c84a65/PKG_HASH:=26dd40e60848710f4fd77f8d1191ae8ad506c710ad471723af51da807375a638/' feeds/packages/net/tailscale/Makefile
