...
# 修改tailscale版本为官网最新v1.66.0 https://github.com/tailscale/tailscale
sed -i 's/PKG_VERSION:=1.44.3/PKG_VERSION:=1.66.0/' feeds/packages/net/tailscale/Makefile
sed -i 's/PKG_HASH:=9d0cdccf103d3613ea4671e7092a18e9b7a471f30b4d92defb001510262e48d5/PKG_HASH:=f26641a421b77e360dfb4ca7c3bc27ad2a4f3c537923eaff1d82d7fafd244682/' feeds/packages/net/tailscale/Makefile
